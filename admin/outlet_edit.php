...
<form id="form" method="POST">
    ...
    <input type="hidden"  value="<?= $edit['id_outlet']; ?>" name="id_outlet">
    <label>Nama Outlet</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?=$edit['nama_outlet']; ?>" name="nama_outlet" class="input" required>
            </div>
                    <label>Alamat Outlet</label>
            <div class="content-inputs">
            <input type="text" value="<?=$edit['alamat_outlet']; ?>" name="alamat_outlet" class="input"  required>
                  
            </div>
                    <label>Nomor Telepon</label>
            <div class="content-inputs"> 
                    <input type="text" value="<?=$edit['telp_outlet']; ?>" name="telp_outlet" class="input"  required>
            </div>
